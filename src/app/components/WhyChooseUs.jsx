  ...
  const coreFeatures = [
    {
      ...
      image: "https://images.unsplash.com/photo-1556761175-4b46a572b786?q=80&w=1974&auto=format&fit=crop", // Business Growth Image
    },
    {
      icon: Handshake,
      title: "ENVISION SUCCESS",
      description: "Deliver seamless user experience and navigation using digital innovation.",
      image: "https://images.unsplash.com/photo-1521791136064-7986c2920216?q=80&w=2069&auto=format&fit=crop", // Handshake/Partnership Image
    },
    {
      icon: Globe,
      title: "STRONG FOUNDATIONS",
      description: "Connect with a responsive web design agency – unlock your business reach.",
      image: "https://images.unsplash.com/photo-1451187580459-43490279c0fa?q=80&w=2072&auto=format&fit=crop", // Global Network Image
    },
  ];
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <motion.div
          ...
          className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 auto-rows-[380px] md:auto-rows-[420px]"
        >
          
          {/* Card 1: Large Image Card (Spans 2 cols on Desktop) */}
          <motion.div 
            variants={itemVariants}
            className="md:col-span-2 relative rounded-3xl overflow-hidden group border border-white/5 hover:border-[#e1c693]/30 transition-all duration-700"
          >
            <img
          ...
          {/* Card 2: Medium Image Card (Replaced Abstract with Image) */}
          <motion.div 
            variants={itemVariants}
            className="relative rounded-3xl overflow-hidden group border border-white/5 hover:border-[#e1c693]/30 transition-all duration-700"
          >
            <img
          ...
          {/* Card 3, 4, 5: Feature Cards with Images */}
          {coreFeatures.map((feature, index) => (
            <motion.div
              key={index}
              variants={itemVariants}
              className="relative rounded-3xl overflow-hidden group border border-white/5 hover:border-[#e1c693]/40 transition-all duration-700 cursor-pointer"
              whileHover={{ y: -5 }}
            >
              {/* Background Image */}
              <img
